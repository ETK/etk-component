...
/**
 * A processor generating IOC dependency files
 *
...
public class IOCProcessor extends AbstractProcessor
{
   ...
   private static final String DEPENDENCY_DIR = "conf";

   private static final String DEPENDENCY_FILE = "dependencies.xml";
